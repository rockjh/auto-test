...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> success(T data) {
        ...
        result.setCode(AutoTestErrorCode.SUCCESS.getCode());
        result.setMessage(AutoTestErrorCode.SUCCESS.getMessage());
        result.setData(data);
        return result;
    }
     ...
     * @return 包装后的失败响应
     */
    public static <T> CommonResult<T> failure(ErrorCode errorCode, String message) {
